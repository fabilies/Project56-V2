...
namespace Project56_new.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ChangeAdres(ChangeAdresViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
            ...
            _logger.LogInformation("User changed their  adres information");
            StatusMessage = "Adres gegevens zijn bijgewerkt";
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Project56_new"),
